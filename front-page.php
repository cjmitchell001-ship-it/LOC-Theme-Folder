...
<section class="loc-areas">
    ...
    <div class="loc-areas__postcode-list">

        <div class="loc-areas__group">
            <h4 class="loc-areas__group-title">Leicester City &amp; Inner Suburbs</h4>
            <ul class="loc-areas__tags">
                <li>Leicester City Centre <span>LE1</span></li>
        ...
        <div class="loc-areas__group">
            <h4 class="loc-areas__group-title">North &amp; West Leicester</h4>
            <ul class="loc-areas__tags">
        ...
        <div class="loc-areas__group">
            <h4 class="loc-areas__group-title">North &amp; East Leicester</h4>
            <ul class="loc-areas__tags">
        ...
        <div class="loc-areas__group">
            <h4 class="loc-areas__group-title">South Leicestershire</h4>
            <ul class="loc-areas__tags">
