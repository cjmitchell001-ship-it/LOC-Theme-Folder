    ...
    <div class="loc-step3-calendar-col">
        ...
        <div class="loc-step3-legend">
            <div class="loc-step3-legend-item">
                <span class="loc-step3-legend-swatch loc-step3-legend-swatch--open" aria-hidden="true"></span>
                <span>Open</span>
            </div>
            <div class="loc-step3-legend-item">
                <span class="loc-step3-legend-swatch loc-step3-legend-swatch--booked" aria-hidden="true"></span>
                <span>Booked</span>
            </div>
            <div class="loc-step3-legend-item">
