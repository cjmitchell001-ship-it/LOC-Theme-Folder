	...
	<section class="loc-location-section loc-location-section--alt">
		<div class="loc-location-section__inner">
			...
			<div class="loc-location-prices">
				...
				<?php /* HOB ROWS ARE GAS PRICES, DELIBERATELY. Everywhere else on the site a
				         ...
				         A PHP COMMENT, NOT AN HTML ONE, ON PURPOSE. This page is public
				         (/services/range-cooker-prices/, indexable, linked from /services/)
				         and an HTML comment is served to the browser in full — the discount
				         line above would be sitting in View Source on the pricing page for
				         anyone to quote back. Keep any note here server-side. */ ?>
