    ...
    <div class="loc-step1-selection">
        ...
        <div class="loc-appliance-group">
            ...
            <div class="loc-appliance-cards">
                ...
                <!-- Single Oven -->
                <div class="loc-appliance-card" data-name="Single Oven" data-price="<?php echo $loc_eb ? '55' : '70'; ?>">
                ...
                <!-- Double Oven -->
                <div class="loc-appliance-card" data-name="Double Oven" data-price="<?php echo $loc_eb ? '70' : '90'; ?>">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Free-Standing Oven -->
                <div class="loc-appliance-card" data-name="Free-Standing Oven" data-price="<?php echo $loc_eb ? '55' : '70'; ?>">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="loc-appliance-group">
            ...
            <div class="loc-appliance-cards">
                ...
                <!-- Gas Hob -->
                <div class="loc-appliance-card" data-name="Gas Hob" data-price="15">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="loc-appliance-card__price">From £15</p>
                    <div class="loc-aga-options">
                        <p class="loc-aga-options__label">Add more</p>
                        <div class="loc-qty-stepper__controls">
                            <button class="loc-qty-btn loc-qty-btn--minus">−</button>
                ...
                <div class="loc-appliance-card" data-name="Ceramic / Induction Hob" data-price="15">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="10" y="20" width="100" height="80" rx="4" stroke="#1A3A6E" stroke-width="3" fill="none"/>
                ...
                <!-- Extractor Hood -->
                <div class="loc-appliance-card" data-name="Extractor Hood" data-price="15">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <!-- duct pipe at top -->
                ...
                <!-- Microwave -->
                <div class="loc-appliance-card" data-name="Microwave" data-price="15">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Combi Microwave -->
                <div class="loc-appliance-card" data-name="Combi Microwave" data-price="20">
                    <svg width="64" height="64" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <!-- outer body -->
                        <rect x="8" y="30" width="104" height="60" rx="4" stroke="#1A3A6E" stroke-width="3" fill="none"/>
                        <!-- door cavity -->
