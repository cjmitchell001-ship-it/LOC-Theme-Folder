...
/**
 * Template Name: About
 * About page — Leicester Oven Cleaning
 */
        ...
        <div class="loc-about-intro__inner">
            ...
            <div class="loc-about-intro__card">
                <div class="loc-about-intro__card-inner">
                    ...
                    <p class="loc-about-intro__quote">"The goal is simple — leave every oven cleaner than I found it, and every customer glad they booked."</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="loc-about-values__inner">
            ...
            <div class="loc-about-values__grid">
                ...
                <div class="loc-about-values__card">
                    ...
                    <p class="loc-about-values__card-title">Oven ready same day</p>
                    <p class="loc-about-values__card-text">Every clean ends with a full function check. By the time I leave, your oven is reassembled, tested, and ready to use. Same day, without exception.</p>
                </div>
                ...
                <div class="loc-about-values__card">
                    <div class="loc-about-values__icon">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" stroke="#1A3A6E" stroke-width="2" stroke-linecap="round"/><circle cx="9" cy="7" r="4" stroke="#1A3A6E" stroke-width="2"/></svg>
                    </div>
                    <p class="loc-about-values__card-title">Just me</p>
                    <p class="loc-about-values__card-text">No team, no subcontractors. When you book, you know exactly who's coming. The same person every time, building the same standard every time.</p>
                </div>
        ...
        <div class="loc-about-credentials__inner">
            ...
            <div class="loc-about-credentials__grid">
                ...
                <div class="loc-about-credentials__item">
                    ...
                    <p class="loc-about-credentials__label">Public Liability</p>
                    <p class="loc-about-credentials__value">Fully insured — details available on request</p>
                </div>

                <div class="loc-about-credentials__item">
                    <div class="loc-about-credentials__icon">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="#C9960C" stroke-width="2"/><path d="M9 12l2 2 4-4" stroke="#C9960C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </div>
                    <p class="loc-about-credentials__label">Treatment Risk Cover</p>
